    ...
    if (_initialized && _started) {
      return Center(
        child: InteractiveViewer(
          maxScale: widget.betterPlayerController.betterPlayerConfiguration.maxScale,
          panEnabled: widget.betterPlayerController.betterPlayerConfiguration.zoomAndPan,
          scaleEnabled: widget.betterPlayerController.betterPlayerConfiguration.zoomAndPan,
          child: ClipRect(
            child: Container(
              width: double.infinity,
